...
BEGIN
    ...
    INSERT INTO Hotel.Employee( employee_id,national_code, birthday, first_name, last_name, phone_number, address, salary, hire_date, is_active, gender,[role])
    SELECT employee_id,national_code, birthday, first_name, last_name, phone_number, address, salary, hire_date, is_active, CASE when is_male = 1 then  'male' else 'female' end,[role]
